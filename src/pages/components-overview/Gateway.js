...
import {  loadAllGateway, loadGatewayByOrganisationAndLocation } from 'utils/user-service';
        ...
        <TableBody>
          {gateways.map((row) => (
            ...
            >
              ...
              <TableCell component="th" scope="row" align="center">
                <Link color="black"  to={`/user/gateways/org/${row.organisation.orgId}/location/${row.location.id}/gateway/${row.gatewayId}`} component={RouterLink} style={{ textDecoration: 'none' }}>
