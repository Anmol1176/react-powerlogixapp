...
import { loadAllOrganisation, loadLocationsByOrganisation, saveGateway } from 'utils/user-service';
import { toast } from 'react-toastify';

function AddGatewayFull() {
                  ...
                  <Grid item xs={12} md={4}>
                    <Stack spacing={1}>
                      ...
                      <Select
                        ...
                        onChange={(e) => {
                          fieldChange(e);
                          loadLocationsByOrganisation(e.target.value)
                            .then((data) => {
                              setLocations(data);
                            })
                            .catch((error) => {
                  ...
                  <Grid item xs={12} md={4}>
                    <Stack spacing={1}>
                      ...
                      <Input
                        ...
                        placeholder="Gateway Point Name (In Lowercase)"
                      />
